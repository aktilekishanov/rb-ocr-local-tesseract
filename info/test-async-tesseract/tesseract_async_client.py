...
class TesseractAsyncClient:
    def __init__(self, base_url: str = "https://dev-ocr.fortebank.com/v2", timeout: float = 60.0) -> None:
    ...
    async def upload(self, file_path: str) -> Dict[str, Any]:
        if self._client is None:
            raise RuntimeError("Client is not started. Use 'async with TesseractAsyncClient()' or call __aenter__().")
